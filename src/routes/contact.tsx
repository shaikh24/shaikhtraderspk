...
export const Route = createFileRoute("/contact")({
  head: () => ({ meta: [{ title: "Contact — Shaikh Traders" }, { name: "description", content: "Get in touch with Shaikh Traders Private Limited for inquiries, quotes and partnerships." }] }),
  component: () => (
        ...
        <aside className="space-y-5">
          <div className="rounded-2xl border border-border bg-card p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li className="flex gap-3"><Phone className="mt-0.5 h-4 w-4 text-gold" />{SITE.phone}</li>
              <li className="flex gap-3"><Mail className="mt-0.5 h-4 w-4 text-gold" />{SITE.email}</li>
            </ul>
          </div>
